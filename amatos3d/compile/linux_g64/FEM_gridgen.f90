...
!---------- normalize tetra: set some pointers, initialize some indices and flags
	...
	i_refside	=  abs(p_elmt4%att%i_mark)          ! nur innerhalb von p_elmt4 gültig!!!
	i_ind1		=  mod(i_refside, DEF_eledges)+ 1   ! nur innerhalb von p_elmt4 gültig!!!
	i_ind2		=  mod(i_refside+1, DEF_eledges)+ 1 ! nur innerhalb von p_elmt4 gültig!!!
	...
	i_refside	=  abs(p_elmt3%att%i_mark)           ! nur innerhalb von p_elmt3 gültig!!!
	i_ind1		=  mod(i_refside, DEF_eledges)+ 1    ! nur innerhalb von p_elmt3 gültig!!!
	i_ind2		=  mod(i_refside+ 1, DEF_eledges)+ 1 ! nur innerhalb von p_elmt3 gültig!!!
...
!           (based on "Local Mesh Refinement in 2 and 3 Dimensions" by Eberhard Bänsch)
